...
class MessageBox(object):
    ...
    def aboutIbook(self):
        ...
        background = tkinter.Label(about, width=290, height=140, bg='dim gray')
        background.pack()

        title = tkinter.Label(about, text='ibook', fg='white', bg='dim gray', font=('Arial', 18, 'bold'))
        title.place(x=115, y=15)

        information = tkinter.Label(about, text= 
        ...
        powerbutton = tkinter.Button(about,text = 'Power', 
            width=8, height=1 , fg='white', bg='dim gray', 
            command=power.power, font=('Arial', 8, 'bold'))

        powerbutton.place(x=40, y=21)

    def printMessage(self):
        self.message.showerror('ibook Print', '  ' + 'Please connect a printing device' + '        ')
